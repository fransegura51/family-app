...
const SUMMARIES: Record<string, string> = {
  ...
  '/eventos': 'Organiza cumpleaños, comuniones, bautizos, celebraciones, bodas íntimas o cualquier evento personalizado: invitados, presupuesto ligado a Economía, menú con traspaso a Compras, ceremonia, proveedores y pagos — invitaciones y RSVP público llegan en próximas actualizaciones.',
...
const HELP_DETAILS: Record<string, HelpItem[]> = {
  ...
  '/eventos': [
    ...
    { title: 'Invitados', text: 'Alta mínima — nombre o familia, adultos y niños, sin tener que importar contactos. El estado de cada uno (Pendiente/Confirmado/No asiste/No seguro) se cambia a mano por ahora; al confirmar, apunta cuántos adultos y niños vienen de verdad. En Comunión/Bautizo/Boda, cada invitado elige si va a la ceremonia, a la celebración o a las dos.' },
