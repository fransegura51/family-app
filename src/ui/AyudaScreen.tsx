...
const HELP_DETAILS: Record<string, HelpItem[]> = {
  ...
  '/compras': [
    ...
    { title: 'No alimentos', text: 'El mismo historial pero para ropa, electrónica y demás compras que no son de comida — nunca se mezcla con Alimentación. Todo lo comprado en tienda física cuenta como Alimentación por defecto; si un producto suelto no lo es (una bombona, unas plantas...), toca su nombre y usa el botón 🚫 de su ficha para moverlo — se puede deshacer igual desde ahí (✅).' },
    ...
    { title: 'Estadística compras', text: '"Total Registrado en Compras" suma Alimentación y No alimentos, con el importe de cada uno y qué porcentaje representa tanto de las compras como del gasto total de Economía en ese periodo — filtra por Hoy/Esta semana/Este mes/Este año/Rango con el mismo botón "📅 Fecha" que el resto de la app. "No alimentos" cuenta los tickets/pedidos que no sean de Alimentación más cualquier gasto metido a mano en Economía bajo "Compras y familia" (Ropa, Niños, Casa y jardín, Tecnología, Mascotas, Regalos...). Debajo, tres dónuts: por tienda, por tipo de alimento (Supermercado, Restaurantes...) y por categoría de lo no-alimentos.' },
  ],
  '/alimentacion': [
