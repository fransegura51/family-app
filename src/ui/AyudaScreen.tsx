...
const HELP_DETAILS: Record<string, HelpItem[]> = {
  ...
  '/dinero': [
    ...
    { title: 'Movimientos', text: 'Todos los gastos e ingresos del periodo, editables uno a uno — con el mismo filtro "📅 Fecha" desplegable que el resto de Economía (Mes contable/Mes real incluidos), en vez de la navegación por mes de antes.' },
