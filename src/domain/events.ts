...
export const INVITATION_TEMPLATES: InvitationTemplateMeta[] = [
  ...
  { key: 'floral', label: 'Floral', gradient: 'linear-gradient(160deg, #FFE4E6, #FED7AA)', text: '#7C2D12', artKey: 'floral', image: invitaFloralJardin, imageAspect: 0.6667, textArea: { x: 0.29, y: 0.2, width: 0.49, height: 0.7 } },
  ...
  { key: 'coches', label: 'Coches de carreras', gradient: 'linear-gradient(160deg, #1F2937, #7F1D1D)', text: '#ffffff', artKey: 'coches', image: invitaCoches, imageAspect: 0.4829, textArea: { x: 0.12, y: 0.16, width: 0.66, height: 0.6376 } },
  // Lote 3.
  ...
  { key: 'granja', label: 'Granja', gradient: 'linear-gradient(160deg, #FDE9D9, #DC2626)', text: '#7C2D12', artKey: 'confeti', image: invitaGranja, imageAspect: 0.6667, textArea: { x: 0.19, y: 0.19, width: 0.6, height: 0.77 } },
  ...
  { key: 'comunion', label: 'Comunión', gradient: 'linear-gradient(160deg, #ECFDF5, #D1FAE5)', text: '#166534', artKey: 'confeti', image: invitaComunion, imageAspect: 0.6667, textArea: { x: 0.3, y: 0.17, width: 0.45, height: 0.68 } },
  ...
  { key: 'navidad_dorada', label: 'Navidad dorada', gradient: 'linear-gradient(160deg, #F5F0E6, #E7DFC6)', text: '#7C2D12', artKey: 'confeti', image: invitaNavidadDorada, imageAspect: 0.6667, textArea: { x: 0.24, y: 0.13, width: 0.48, height: 0.68 } },
  ...
  { key: 'navidad_galletas', label: 'Navidad galletas', gradient: 'linear-gradient(160deg, #B45309, #78350F)', text: '#FFF7ED', artKey: 'confeti', image: invitaNavidadGalletas, imageAspect: 0.5911, textArea: { x: 0.2, y: 0.15, width: 0.55, height: 0.68 } },
  { key: 'navidad_farolillos', label: 'Navidad farolillos', gradient: 'linear-gradient(160deg, #1E3A8A, #0F172A)', text: '#ffffff', artKey: 'confeti', image: invitaNavidadFarolillos, imageAspect: 0.5895, textArea: { x: 0.34, y: 0.12, width: 0.58, height: 0.66 } },
  { key: 'halloween_calabaza', label: 'Halloween calabaza', gradient: 'linear-gradient(160deg, #C2410C, #451A03)', text: '#FFF7ED', artKey: 'confeti', image: invitaHalloweenCalabaza, imageAspect: 0.6531, textArea: { x: 0.1, y: 0.24, width: 0.78, height: 0.63 } },
  ...
  { key: 'halloween_bruja', label: 'Halloween bruja', gradient: 'linear-gradient(160deg, #166534, #1E1B4B)', text: '#ffffff', artKey: 'confeti', image: invitaHalloweenBruja, imageAspect: 0.6531, textArea: { x: 0.33, y: 0.2, width: 0.5, height: 0.72 } },
  { key: 'halloween_fantasmas', label: 'Halloween fantasmas', gradient: 'linear-gradient(160deg, #C2410C, #1E1B4B)', text: '#FFF7ED', artKey: 'confeti', image: invitaHalloweenFantasmas, imageAspect: 0.6531, textArea: { x: 0.2, y: 0.13, width: 0.55, height: 0.58 } },
  ...
  { key: 'carnaval_plumas', label: 'Carnaval plumas', gradient: 'linear-gradient(160deg, #0EA5E9, #DB2777)', text: '#ffffff', artKey: 'confeti', image: invitaCarnavalPlumas, imageAspect: 0.6667, textArea: { x: 0.3, y: 0.2, width: 0.38, height: 0.65 } },
  // GRUPO C — marcada para futuro rediseño. NO tocar ahora.
