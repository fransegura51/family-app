...
const HELP_DETAILS: Record<string, HelpItem[]> = {
  ...
  '/familia': [
    { title: 'Peso y medidas', text: 'Pestaña propia dentro de Familia, aparte de los miembros. Para un bebé o niño pequeño (hasta 5 años, con fecha de nacimiento y sexo indicados en su ficha) muestra su percentil exacto de peso, altura y perímetro cefálico con las curvas oficiales de la OMS, una gráfica con esas curvas (toca un punto para ver esa medida) y una tabla con el percentil de cada medida; es orientativo, consulta siempre con el pediatra. Para el resto: elige a la persona arriba y registra su peso y medidas (cintura, abdomen, brazo, pierna); verás la evolución en un gráfico. También puedes subir fotos de evolución. Antes vivía dentro de La cocina de Pepa (y el Registro de comidas se eliminó).' },
