...
const HELP_DETAILS: Record<string, HelpItem[]> = {
  ...
  '/compras': [
    ...
    { title: 'Estadística compras', text: '"Total Registrado en Compras" suma Alimentación y Otros, con el importe de cada uno y qué porcentaje representa tanto de las compras como del gasto total de Economía en ese periodo — filtra por Hoy/Esta semana/Mes contable/Mes real/Este año/Rango con el mismo botón "📅 Fecha" que Presupuesto Generales. "Otros" cuenta los tickets/pedidos que no sean de Alimentación más cualquier gasto metido a mano en Economía bajo "Compras y familia" (Ropa, Niños, Casa y jardín, Tecnología, Mascotas, Regalos...). Cada importe lleva su "Ver movimientos →", que lleva directo a Movimientos (en Economía) ya filtrado con exactamente esos mismos gastos. Debajo, tres dónuts: por tienda y por categoría de Otros llevan el mismo enlace al tocar una porción; por tipo de alimento (Verdura, Fruta, Carne, Pescado, Lácteos y huevos, Panadería, Bebidas, Congelados, Snacks, Despensa...) clasifica cada producto de los tickets por su nombre — sin enlace a movimientos, porque un mismo ticket mezcla varios tipos a la vez. Es una clasificación automática por palabras clave, no perfecta; un producto que no encaje en ninguno cae en "Otros alimentos". Debajo del dónut, una lista con cada tipo y su % del total — toca uno para desplegar los productos concretos que lo forman, con su importe y el % que representan dentro de ese tipo.' },
  ],
  '/alimentacion': [
