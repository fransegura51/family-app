...
const HELP_DETAILS: Record<string, HelpItem[]> = {
  ...
  '/familia': [
    { title: 'Peso y medidas', text: 'Pestaña propia dentro de Familia, aparte de los miembros. Para un bebé o niño pequeño (hasta 5 años, con fecha de nacimiento y sexo indicados en su ficha) muestra su percentil exacto de peso, altura y perímetro cefálico con las curvas oficiales de la OMS, una gráfica con esas curvas (toca un punto para ver esa medida) y una tabla con el percentil de cada medida; es orientativo, consulta siempre con el pediatra. Para los niños (a partir de 2 años, o cualquier niño/a aunque no tenga fecha) hay un medidor de altura ilustrado: eliges entre 10 diseños (cohete, dinosaurios, árbol, fondo marino, castillo, selva, arcoíris, bomberos, granja y monstruos) y un personaje sube a la altura medida sobre una regla con marcas cada 5 cm; toca un punto de colores para ver una medida anterior y al personaje para cambiar entre niño y niña; al guardar una medida nueva celebra y te dice cuánto ha crecido. El diseño es solo aspecto (se guarda en este móvil): las medidas son siempre las mismas cambies de diseño o no. Para el resto: elige a la persona arriba y registra su peso y medidas (cintura, abdomen, brazo, pierna); verás la evolución en un gráfico. También puedes subir fotos de evolución. Antes vivía dentro de La cocina de Pepa (y el Registro de comidas se eliminó).' },
...
const SETTINGS_ENTRY = {
  ...
  details: [
    { title: 'Cómo está organizada', text: 'Debajo del nombre de familia hay una lista limpia de temas, cada uno con su color, (Organizar menú, Colores, Economía, Compras y cocina, Seguridad): toca uno para abrir su sección, y vuelve a tocarlo para recogerla. Solo hay uno abierto a la vez.' },
