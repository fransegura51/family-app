...
const SETTINGS_ENTRY = {
  ...
  details: [
    { title: 'Cómo está organizada', text: 'Debajo del nombre de familia hay una lista limpia de temas (Organizar menú, Colores, Economía, Compras y cocina, Seguridad): toca uno para abrir su sección, y vuelve a tocarlo para recogerla. Solo hay uno abierto a la vez.' },
