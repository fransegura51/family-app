...
const HELP_DETAILS: Record<string, HelpItem[]> = {
  ...
  '/familia': [
    { title: 'Peso y medidas', text: 'Pestaña propia dentro de Familia, aparte de los miembros: elige a la persona arriba y registra su peso y medidas (cintura, abdomen, brazo, pierna); verás la evolución en un gráfico. También puedes subir fotos de evolución. Antes vivía dentro de La cocina de Pepa (y el Registro de comidas se eliminó).' },
