...
const HELP_DETAILS: Record<string, HelpItem[]> = {
  ...
  '/dinero': [
    ...
    { title: 'Estadísticas', text: 'Debajo de "Mis cuentas" está "Tendencia del saldo" (solo se ve aquí): la evolución del saldo día a día, reconstruida a partir de los movimientos guardados, con eje de euros y de fechas — viendo "Todas" se dibuja como franjas apiladas, una por cuenta y con su color (el del miembro asignado, o gris "🏠 Común" si no tiene dueño). Debajo, los dónuts por categoría, etiqueta, Debo/Necesito/Quiero y Fijo/Variable — toca una porción para ver justo esos movimientos. Cada categoría tiene siempre el mismo color (sus subcategorías, el mismo tono en distinta intensidad), agrupadas en la leyenda (a la izquierda del dónut) por categoría padre. "Evolución temporal" (últimos 6 meses) respeta el día de inicio del mes contable que hayas puesto en Configuración.' },
