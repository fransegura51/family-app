...
const SETTINGS_ENTRY = {
  ...
  details: [
    ...
    { title: 'Estilo de color', text: 'En Colores eliges entre Pastel (el de siempre) y Vivo (más saturado) para TODA la app: Inicio, menús, Calendario, Compras, Economía, Cocina... Es solo de este móvil, y al elegir otro estilo la app se recarga para repintarlo todo. En Vivo el texto secundario y los enlaces se oscurecen un poco para seguir leyéndose.' },
